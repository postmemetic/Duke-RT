...
static constexpr uint32_t NRI_TRACE_SHADER_BASE_SCALAR_STAT_COUNT = 78;
...
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_FINAL_VALID = 22;
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_FINAL_SOURCE = 23;
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_FINAL_INSTANCE = 24;
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_FINAL_PRIMITIVE = 25;
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_FINAL_CHUNK = 26;
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_FINAL_POSITION_X = 27;
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_FINAL_POSITION_Y = 28;
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_FINAL_POSITION_Z = 29;
static constexpr uint32_t NRI_TRACE_SHADER_PROBE_RAY_STRIDE = 30;
...
static_assert(NRI_TRACE_SHADER_SCALAR_STAT_COUNT == 274);
