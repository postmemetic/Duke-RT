...
CVAR(Float, nri_ptsmokethicknesspivot, 0.12f, 0)
CVAR(Int, nri_ptsmokethicknesssteps, 2, 0)
CVAR(Float, nri_ptsmokeflowhighlight, 0.0f, 0)
CVAR(Float, nri_ptsmokeflowspeedreference, 32.0f, 0)
CVAR(Float, nri_ptsmokecurlhighlight, 0.0f, 0)
CVAR(Float, nri_ptsmokecurlreference, 1.0f, 0)
CVAR(Float, nri_ptsmokecompressionsculpt, 0.0f, 0)
CVAR(Float, nri_ptsmokedivergencereference, 1.0f, 0)
CVAR(Float, nri_ptsmokebandstrength, 0.0f, 0)
CVAR(Int, nri_ptsmokebandcount, 4, 0)
CVAR(Float, nri_ptsmokebandsoftness, 0.25f, 0)
